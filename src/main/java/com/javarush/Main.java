...
public class Main {
    ...
    private void newFilmWasMade() {
        try (Session session = sessionFactory.getCurrentSession()) {
            ...
            film.setDescription("my desc1");
            film.setTitle("Good film1");
            ...
            filmText.setDescription("my desc1");
            filmText.setTitle("Good film1");
    ...
    private Customer createCustomer() {
        try (Session session = sessionFactory.getCurrentSession()) {
            ...
            address.setAddress("Independent str, 24");
            address.setPhone("999-111-555");
            address.setCity(city);
            address.setDistrict("dasdas");
